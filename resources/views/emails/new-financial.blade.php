...
<head>
    ...
    <title>Nova publicação financeira publicado</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Nova publicação financeira Disponível</h1>
        ...
        <div class="content">
            ...
            <p style="color: #555; margin-bottom: 25px;">
                Temos uma nova publicação financeira que foi adicionada no portal académico.
            </p>
