...
<head>
    ...
    <title>Nova Publicação - {{ $university->name }}</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Nova Publicação Disponível</h1>
        ...
        <div class="content">
            ...
            <p style="color: #555; margin-bottom: 25px;">
                Temos uma nova publicação que foi adicionada no portal académico.
            </p>
            ...
            <div class="publication-card">
                ...
                <div class="publication-meta">
                    ...
                    <div class="meta-item">
                        <strong>📎 Anexo:</strong> Disponível
                    </div>
                    @endif
                </div>
                
                <a href="{{ config('app.frontend_url', 'http://localhost:3000') }}/publications/{{ $publication->id }}" class="cta-button">
