...
class StudentInformationService
{
    ...
    public function getBankInformationByStudent(int $studentCode): ?array
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return [
                    'success' => true,
                    'data' => $data,
                    'message' => 'Informações bancárias obtidas com sucesso.'
                ];
            } else {
                ...
                return [
                    'success' => false,
                    'message' => 'Erro ao obter informações bancárias: HTTP ' . $response->status(),
                    'error' => $response->body()
                ];
            }

        } catch (Exception $e) {
            Log::error('Exceção ao buscar informações bancárias', [
            ...
            return [
                'success' => false,
                'message' => 'Erro interno ao buscar informações bancárias.',
                'error' => $e->getMessage()
            ];
        }
    }
